...
class JsonGeneratorInspectionWrapper(GraphRagJsonGen, BoardJsonGen, ExpertSetJsonGen, RecovJsonGen, ReceptJsonGen):
    def __init__(self, json_gen: GraphRagJsonGen | BoardJsonGen | ExpertSetJsonGen | RecovJsonGen | ReceptJsonGen) -> None:
