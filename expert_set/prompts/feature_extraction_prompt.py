...
from ..models import PaperFeatureExtraction
...
Respond as a JSON object with feature names as keys and extracted values as the response, as
per the following schema
{json.dumps(PaperFeatureExtraction.model_json_schema(), indent=2)}
"""
