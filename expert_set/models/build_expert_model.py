...
class BuildExpertCommand(BaseModel):
    ...
    name: str = Field(description="Name or identifier of the expert", examples=[
        "Dr. Alex Martinez", 
        "Prof. Sarah Johnson"
    ])
    description: str = Field(description="Brief description of the expert's specialties and background", examples=[
    ...
    query: str = Field(description="Query to search for surveys about the expert's topic", examples=[
